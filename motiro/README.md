...
├── assets/
│   └── logo.jpeg        → Logo da Motirõ (COLOQUE AQUI A IMAGEM ORIGINAL)
└── php/
...
3. Nome: `computacao_motiro` | Collation: `utf8mb4_unicode_ci`
4. Clique em "Criar"
5. Selecione o banco `computacao_motiro` e clique em "SQL"
...
define('DB_NOME',   'computacao_motiro'); // Nome do banco criado
...
1. Faça upload de todos os arquivos do projeto para o diretório `public_html/`
2. Certifique-se de que a pasta `assets/` contém o arquivo `logo.jpeg`

### 4. Logo da Startup

- Use o arquivo `assets/logo.jpeg` como logo oficial do site
